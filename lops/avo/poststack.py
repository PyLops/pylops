...
from lops.signalprocessing import Convolve1D
from lops.utils.signalprocessing import convmtx
from lops.utils import dottest as Dottest
from lops import MatrixMult, FirstDerivative, SecondDerivative, Laplacian
from lops.optimization.leastsquares import RegularizedInversion
...
def PoststackInversion(data, wav, m0=None, explicit=False, simultaneous=False,
    ...
    * ``explicit=False`` with ``epsR``: the iterative solver
      :py:func:`lops.optimization.leastsquares.RegularizedInversion` is used
