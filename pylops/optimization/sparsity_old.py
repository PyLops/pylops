...
from pylops.optimization.leastsquares_old import (
    NormalEquationsInversion,
    RegularizedInversion,
)
from pylops.optimization.solver_old import cgls
...
def _IRLS_data(
    ...
    **kwargs_solver,
    ...
    xinv = NormalEquationsInversion(Op, None, data, epsI=epsI, **kwargs_solver)
    r = data - Op * xinv
    if returnhistory:
        xinv_hist[0] = xinv
