...
Optimization
============
This tutorial will guide you through the :py:mod:`lops.optimization` module and
...
# :math:`\mathbf{x}` at random locations is implemented using :py:class:`lops.Restriction`, and
#
#   .. math::
...
plt.plot(t, ymask, '.g', ms=15, label='masked samples')
...
###############################################################################
# We could also use :py:func:`lops.optimization.leastsquares.NormalEquationsInversion`
# (without regularization term for now) and customize our solvers using ``kwargs``.
xinv = \
    lops.optimization.leastsquares.RegularizedInversion(Rop, [], y,
...
#
# The method :py:func:`lops.optimization.leastsquares.NormalEquationsInversion` implements
...
xne = lops.optimization.leastsquares.NormalEquationsInversion(Rop, [], y)
...
xreg = lops.optimization.leastsquares.RegularizedInversion(Rop, [D2op], y,
...
# using the routine :py:func:`lops.optimization.leastsquares.PreconditionedInversion`.

# Create regularization operator
Sop = lops.Smoothing1D(nsmooth=11, dims=[N], dtype='float64')

# Invert for interpolated signal
xprec = lops.optimization.leastsquares.PreconditionedInversion(Rop, Sop, y,
                                                               returninfo=False,
