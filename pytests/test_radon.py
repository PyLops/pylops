...
def test_Radon2D(par):
    ...
    Rop = Radon2D(t, h, px, centeredh=par['centeredh'],
                  ...
                  dtype='float64')
    R1op = Radon2D(t, h, px, centeredh=par['centeredh'],
                   interp=par['interp'], kind=par['kind'],
